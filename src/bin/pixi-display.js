  ...
  Object.assign(Container.prototype, {
    renderWebGL: function(renderer) {
      if (
        ...
        this._activeParentLayer != renderer._activeLayer
      ) {
        return;
      }
      if (!this.visible) {
...
(function(pixi_display) {
  ...
  Object.assign(InteractionManager.prototype, {
    _queue: [[], []],
    _displayProcessInteractive: function(
      point,
      displayObject,
      hitTestOrder,
      interactive,
      ...
      var hit = 0,
        interactiveParent = (interactive =
          displayObject.interactive || interactive);
      ...
      if (displayObject.interactiveChildren && children) {
        for (var i = children.length - 1; i >= 0; i--) {
          ...
          var hitChild = this._displayProcessInteractive(
            point,
            child,
            hitTestOrder,
            interactiveParent,
    ...
    processInteractive: function(
      ...
      this._displayProcessInteractive(
        point,
        displayObject,
        hitTest ? 0 : Infinity,
        false
